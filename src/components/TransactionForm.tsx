...
export default function TransactionForm() {
    ...
    const onSubmit = async (data: TransactionFormData) => {
        try {
            ...
            // TODO: Mostrar toast / limpiar form / redirigir
        } catch (error) {
    ...
    return (
        ...
        >
            ...
            <div>
                ...
                <Select
                    onValueChange={(val) => setValue("category_id", parseInt(val))}
                >
            ...
            <div>
                ...
                <Select
                    onValueChange={(val) =>
                        setValue("payment_method", val as TransactionFormData["payment_method"])
                    }
                >
                    <SelectTrigger className="w-full">
            ...
            <div>
                ...
                <Select
                    onValueChange={(val) => setValue("credit_card_id", parseInt(val))}
                >
                    <SelectTrigger className="w-full">
